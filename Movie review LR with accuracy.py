# -*- coding: utf-8 -*-
"""
Created on Sat Nov 24 23:15:33 2018
...
result = grid_search.predict(test_data_features)

#Printing accuracy, confusion matrix and classification report
print ('Accuracy on test set: {:.2f}'.format(grid_search.score(test_data_features, y_test)))
